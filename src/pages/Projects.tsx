...
const Projects = () => {
  ...
  return (
    <>
      <SEO title='Projects | Anish Gane' description='All the projects that I have worked on with different technologies.' />
      <motion.div
