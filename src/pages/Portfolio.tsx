...
import PortfolioProjectSkeleton from '@/skeletons/portfolio-project-skeleton';
...
const Portfolio = () => {
  return (
    <>
      <SEO title='Home | Anish Gane' description='Portfolio showcasing projects, skills, and experience in web development.' />
      <motion.div
      ...
      >
        <section className="mt-10">
          ...
          <div className="mt-14">
            ...
            <Suspense fallback={<PortfolioProjectSkeleton />}>
              <Project />
            </Suspense>
          </div>
