...
const BookaCall = () => {
  ...
  return (
    <div className="border-neutral-6/50 text-neutral-8 mt-16 mb-8 flex flex-col items-center justify-center gap-4 rounded-xl border border-dashed py-16 text-sm text-center sm:text-lg tracking-tighter transition-colors duration-200">
