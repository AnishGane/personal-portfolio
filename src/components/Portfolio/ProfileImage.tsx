...
const ProfileImage = () => {
  return (
    <div className="flex  flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <div className="relative size-32 rounded-full p-[1.5px]">
        <img
        ...
        <div className="group transition-scale absolute right-[5px] bottom-2 z-90 flex size-5 items-center justify-center rounded-full bg-white shadow-md drop-shadow-neutral-100 duration-200 hover:scale-105 dark:bg-black dark:ring-1 dark:ring-neutral-500">
          <span className="text-neutral-8 text-xs font-semibold pointer-events-none">A</span>
      ...
      <div className='flex-1 sm:ml-10'>
        <h1 className="font-ownBold text-neutral-8 bg-clip-text text-2xl sm:text-4xl"> Hi, I'm Anish —{' '}
          <span className=" text-neutral-6 text-2xl sm:text-3xl"> A{" "} <AnimatedSVG /> {" "} Stack Developer. </span>
        </h1>
      </div>
    </div>
  );
...
const AnimatedSVG = () => {
  return (
    ...
    >
      <span className="text-black dark:text-white leading-none">
        MERN
      </span>
